...
def instructions():
 ...
 until either you guess the correct word or you run out of tries.\n")
    ...
    while ready != "1" and ready != "2":
        ready = input("\n\033[1;31;40mInvalid input, if you are ready press 1 if not press 2:\n")
    # Take user to relevent page.
    if ready == "1":
        play()
    else:
...
def play_again():
    ...
    """
    play_again_q = input("\033[1;36;40mWould you like to play again?\nType 1 for Yes or 2 for No:\n")
    # Make sure users input is valid.
    while play_again_q != "1" and play_again_q != "2":
        play_again_q = input("\n\033[1;31;40mInvalid input, if you want to play again press 1 if not press 2:\n")
    # Take user to relevent page.
    if play_again_q == "1":
        play()
    else:
    ...
    while tries > 0 and guessed is False:
        ...
        if len(users_guess) == 1 and users_guess.isalpha():
            if users_guess in guessed_letters:
                ...
                title()
                print("\033[1;31;40m", users_guess, " is not in the word, try again.")
                tries -= 1
